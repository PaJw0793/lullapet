...
void setup() {
  ...
  if (!particleSensor.begin(Wire, I2C_SPEED_STANDARD)) {
    Serial.println("MAX30102 연결 실패. 다시 확인하세요.");
    while (1);
  }
...
void loop() {
  ...
  bool heartOk = Firebase.setInt(firebaseData, "/sensor/Wearable/device1/sensorData/heartRate", irValue);
